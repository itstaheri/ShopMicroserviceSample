...
namespace PaymentService.Application.Services
{
    ...
    {
        private readonly IDbContextRepository context;

        public PaymentServiceConcrete(IDbContextRepository context)
        {
        ...
        public bool CreatePayment(Guid OrderId, int Amount)
        {
            ...
            else
            {
                ...
                Payment newPayment = new Payment(Amount, OrderId);
        ...
        private Order GetOrder(Guid OrderId, int Amount)
        {
            ...
            {
                Order newOrder = new Order(Amount, OrderId);
        ...
        public void PayDone(Guid Paymentid, string Authority, long RefId)
        {
            ...
            payment.PayDone(true, RefId, DateTime.Now, Authority);
